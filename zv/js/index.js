...
/*     hsl = new d3.hsl(h, s / 100.0, l / 100.0);
      ...
      $('span').html("");
      $('span').append(`${p} %`); 
      $('span').append(`<br /> vlevo = nerozumím &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  vpravo = rozumím`);
/*      $('span').append(`<br /> rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`);
      ...
      return $('body').css("color", `rgb(${Math.min(rgb.r + 96, 0)}, ${Math.min(rgb.g + 96, 0)}, ${Math.min(rgb.b + 96, 0)})`);
    } else {
      return $('b').show();
    }
  }; 
  ...
  $(window).mousemove(function(e) {
    ...
    y = e.pageY;
    h = ~~(x / maxX * 90);
    l = ~~(60-30*Math.abs((x/maxX)-(1/2)));
    r = ~~Math.min((512*(1-x/maxX)),255);
    g = ~~Math.min((512*x/maxX),255);
    p = ~~(100*x/maxX);
    draw();
  });
